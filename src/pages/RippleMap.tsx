...
import kindnesstitles2 from "@/assets/kindness-map/kindness-titles2.png";
...
import redCIlutEUc5 from "@/assets/kindness-map/red-CIlutEUc5.png";
...
import icon from "@/assets/kindness-map/icon.png";
import book from "@/assets/kindness-map/book.png";
import sagaplant from "@/assets/kindness-map/sage-plant.png";
...
<div className="scroll-h" id="zoom-wrapper" >
      ...
      <section className="hero">
          ...
          {/* Title image */}
          <img
            className="hero-title-img map_img"
            src={kindnesstitles}
...
<section className="section pt-0">
        <div className="container">
        <div className="">
          <div className="privacy-grid2">
            <div className="soft-block pink5" style={{ backgroundImage: `url(${redCIlutEUc5})` }}>
     ...
     <section className="section pb-0">
        ...
        <div className="">
          ...
          <div className="filter-row">
            ...
            <select className="select icon" aria-label="Time Range" defaultValue="All time" style={{ backgroundImage: `url(${icon})` }}>
              <option> Individual Ripples</option>
          ...
          <div className="map-caption">
           <span className="font-600"> Viewing:</span>   Helped Mrs. Rose give food to the homeless
            </div> 
            <img src={KindnessMap} alt="Kindness Map" />
            <div className="map-caption2" style={{ backgroundImage: `url(${book})` }}>
  {/*       <img src={book} alt="Story Book" /> */}
    <div className="privacy-grid2">
        <div className="do-dont">
              <img src={sagaplant} alt="Privacy comparison" />
            </div>
            <div className="soft-block2">
              <div className="kindness-privacy-box2">

                <div>
                  <h3 className="mb-10">Sage</h3>

                <p className="para-font mb-10">
                  To protect children and families, the Kindness Map never displays:
                </p>
                <p className="para-font mb-10">
                  To protect children and families, the Kindness Map never displays:
            ...
            <section className="cta-section section-with-user map">
                <div className="container">

                   <div className="sign-wrapper2 map-cta">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="sign-img2" style={{ backgroundImage: `url(${signUpFooter})` }}>
                  {/* <LazyImage
                    src={signUpFooter}
                    alt="Sign up"
                    className="w-full"
