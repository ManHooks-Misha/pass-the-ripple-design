...
export default function TeacherUserProfileDetails() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center space-y-4">
          ...
          <Button onClick={() => navigate('/teacher/manage-students')} size="sm">
    ...
    <div className="w-full px-3 sm:px-4 py-4 sm:py-6 max-w-7xl mx-auto">
      ...
      <div className="mb-4 sm:mb-6">
        <Button
          ...
          className="mb-3 sm:mb-4 hover:bg-gray-100 text-xs sm:text-sm"
        >
