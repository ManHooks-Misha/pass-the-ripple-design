...
import { teacherFeedbackTutorialSteps } from '@/hooks/usePageTutorialSteps';
...
const TeacherFeedback = () => {
  const { isActive, tutorialSteps, startTutorial, completeTutorial, skipTutorial } = usePageTutorial({
    storageKey: "teacher_feedback_tutorial_completed",
    steps: teacherFeedbackTutorialSteps,
  });

  return (
    <div className="space-y-4 sm:space-y-5 md:space-y-6 p-3 sm:p-4 md:p-5 lg:p-6">
      <Seo
        title="Feedback | Teacher Panel"
