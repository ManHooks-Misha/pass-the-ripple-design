...
const RippleCard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-3 sm:py-4 px-3 sm:px-4">
      {/* Tutorial Component */}
      <KidFriendlyTutorial
        isActive={isActive}
      ...
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-5 md:space-y-6 p-3 sm:p-4 md:p-5 lg:p-6">
