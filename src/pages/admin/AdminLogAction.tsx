...
const AdminLogAction = () => {
  ...
  const { isActive, tutorialSteps, startTutorial, completeTutorial, skipTutorial } = usePageTutorial({
    storageKey: "admin_post_story_tutorial_completed",
  ...
  return (
    <div className="min-h-screen bg-gradient-surface">
      <Seo
        title="Log Admin Action — Pass The Ripple"
        description="Record an action as administrator"
        canonical={`${window.location.origin}/admin/post-story`}
      />
      ...
      <main className="container p-3 sm:p-4 md:p-5 lg:p-6">
        ...
        <LogActionComponent
          onSuccess={() => navigate("/admin/my-stories")}
